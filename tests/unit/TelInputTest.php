...
class TelInputTest extends EdificeTestCase {
	...
	public function testSimpleTextInput() {
		$telSimple        = $this->edifice->text('user_phone');
		$telRequiredStyle = $this->edifice->text('user_phone', 'Ghazi', array('class' => 'required', 'required' => 'required'));
		$telPlaceholder   = $this->edifice->text('user_phone', null, array('placeholder' => '411600'));
	...
	public function testTextWithTopLabel() {
		$telWithLabelTopLeft  = $this->edifice->text('user_phone', null, array('label' => array('text' => '411600')));
		$telWithLabelTopRight = $this->edifice->text('user_phone', null, array('label' => array('text' => '411600', 'align' => 'right')));
	...
	public function testTextWithInlineLabel() {
		$telWithLabelInlineLeft  = $this->edifice->text('user_phone', null, array('label' => array('text' => '411600', 'inline' => true)));
		$telWithLabelInlineRight = $this->edifice->text('user_phone', null, array('label' => array('text' => '411600', 'inline' => true, 'align' => 'right')));
	...
	public function testTextWithPrefix() {
		$telWithPrefix = $this->edifice->text('site_url', '411', array('prefix' => array('text' => '+216')));
	...
	public function testTextWithPostfix() {
		$telWithPrefix = $this->edifice->text('site_url', '200', array('postfix' => array('text' => '.com')));
