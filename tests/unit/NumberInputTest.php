...
class NumberInputTest extends EdificeTestCase {
	...
	public function testSimpleTextInput() {
		$numberSimple        = $this->edifice->text('user_age');
		$numberRequiredStyle = $this->edifice->text('user_age', 28, array('class' => 'required', 'required' => 'required'));
		$numberPlaceholder   = $this->edifice->text('user_age', null, array('placeholder' => 'User age'));
	...
	public function testTextWithTopLabel() {
		$numberWithLabelTopLeft  = $this->edifice->text('user_age', null, array('label' => array('text' => 'User age')));
		$numberWithLabelTopRight = $this->edifice->text('user_age', null, array('label' => array('text' => 'User age', 'align' => 'right')));
	...
	public function testTextWithInlineLabel() {
		$numberWithLabelInlineLeft  = $this->edifice->text('user_age', null, array('label' => array('text' => 'User age', 'inline' => true)));
		$numberWithLabelInlineRight = $this->edifice->text('user_age', null, array('label' => array('text' => 'User age', 'inline' => true, 'align' => 'right')));
	...
	public function testTextWithPrefix() {
		$numberWithPrefix = $this->edifice->text('user_age', 28, array('prefix' => array('text' => 'Since')));
	...
	public function testTextWithPostfix() {
		$numberWithPrefix = $this->edifice->text('user_age', 28, array('postfix' => array('text' => 'years')));
